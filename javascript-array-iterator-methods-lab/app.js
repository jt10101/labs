...
veryOldInventors = inventors.filter((x) => x.year >= 1500 && x.year < 1600);
// Check your work:
...
inventorNamedAda = inventors.find((a) => a.first === "Ada");
...
// Complete the exercise in the space below:
firstLast = people.map((a) => a.split(", ")[1] + " " + a.split(", ")[0]);
...
isAdultPresent = devs.some((a) => 2025 - a.year >= 18);
...
isEveryone19OrOlder = devs.every((a) => 2025 - a.year >= 19);
...
totalYearsLived = inventors
  .map((a) => a.passed - a.year)
  .reduce((a, b) => a + b);
